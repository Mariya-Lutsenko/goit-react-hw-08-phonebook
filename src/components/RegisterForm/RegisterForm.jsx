    ...
    return (
        <form action="" onSubmit={handleSubmit}>
            <div className={styles.group}>
                ...
                <input value={name} name="name" onChange={handleChange} className={styles.input} type="text" placeholder="Enter username" required />
            </div>
            <div className={styles.group}>
            ...
            <div className={styles.group}>
                ...
                <input value={password} name="password" onChange={handleChange} className={styles.input} type="password" placeholder="Enter user password" required/>
            </div>
            <div className={styles.group}>
